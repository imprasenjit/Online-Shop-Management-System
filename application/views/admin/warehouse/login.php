			...
			<div class="col-sm-offset-4 col-sm-4">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h1 class="panel-title">Warehouse Login.</h1>
					</div>
                    ...
                    <span id="l_message"></span>
						...
						<div class="form-group" id="input-username" <?php if(isset($username) && !empty($username)){?> style="display:none;" <?php }?>>
							...
							<div class="input-group"><span class="input-group-addon"><i class="fa fa-user"></i></span>
							  <input type="text" name="username" value="<?php echo $username;?>" placeholder="Username" id="s_username" class="form-control" />
							</div>
						</div>
...
<script>
	...
	showUsername=function(){
		...
		$("#signin").click(function() {
			...
			$.ajax({
				url: "<?= base_url("admin/login/warehouse_login_process"); ?>",
				method: "post",
				data: {
					username: username,
					password: password
				...
				success: function(jsn) {
					if (jsn.login) {
						...
						window.location.href="<?=base_url("admin/warehouse/dashboard")?>";
					} else {
