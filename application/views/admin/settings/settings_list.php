                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <div class="dropdown no-arrow">
                          <a class="btn btn-outline-primary btn-sm" href="<?=base_url();?>admin/settings/create" role="button">
                              <i class="fas fa-plus fa-sm"></i> Update settings
                          </a>
                        </div>
                    </div>
                    <!-- Card Body -->
                              ...
                              $.extend($.fn.DataTable.ext.classes, {
                                ...
                                $("#dtbl").DataTable({
                                  "columnDefs": [{
                                    ...
                                    "serverSide": true,
                                    "ajax": {
                                        "url": "<?= base_url("admin/settings/getSettings") ?>",
                                        "dataType": "json",
                                        "type": "POST",
                                    },
                                    language: {
