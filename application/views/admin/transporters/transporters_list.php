        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Transporters List</h6>
                        ...
                        <script type="text/javascript">
                            $(document).ready(function () {
                                ...
                                $("#dtbl").DataTable({
                                    ...
                                    "columns": [
                                        {"data": "slno"},
                                        {"data": "transporter_name", width:200},
                                        {"data": "transporter_mobile"},
                                        {"data": "transporter_address"},
                                        {"data": "transporter_email"},
                                        {"data": "transporter_id"}
                                    ],
                                    "processing": true,
                                    "serverSide": true,
                                    "ajax": {
                                        "url": "<?=base_url("admin/transporters/get_dtrecords")?>",
                                        "dataType": "json",
                                        "type": "POST",
                                    },
                                    language: {
