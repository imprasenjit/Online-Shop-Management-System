                        ...
                        <div class="modal-dialog login animated">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form loginBox" style="width:auto;">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div id="login_with_email_div">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <a class="btn btn-primary submit btn-login" id="signin">Sign In</a>
                                                                <p>
                                    ...
                                    <h3 class="text-center">Sign in with OTP</h3>
                                                    ...
                                                    <div id="login_with_otp_div" style="display:none;">
                                                        ...
                                                        <div class="form-group beforeotp">
                                                            <label class="col-md-4"></label>
                                                            <div class="col-md-8">
                                                                <button id="sendotp" class="btn btn-primary btn-block btn-login" type="button">Send OTP</button>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group afterotp" style="display: none">
                                                            <label class="col-md-4"></label>
                                                            <div class="col-md-8">
                                                                <button id="otplogin" class="btn btn-success btn-block btn-login" type="button">Sign in</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- end of otp block -->
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <button id="sendotprequest" class="btn btn-primary btn-block btn-login" type="button">Send OTP</button>
                                            ...
                                            <button id="reg_btn" class="btn btn-success btn-block btn-login" type="button" style="margin: 10px auto; display: none">Verify OTP</button>
                                        </div>
                                        <div class="col-sm-2"></div>
                                    </div>
                                </div>
                            ...
                            $(document).on("click", "#sendotprequest", function() {
                                ...
                                if (reg_email.length < 8 && reg_mobile.length != 10) {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(res) {
                                            if (res.flag == 1) {
                                                console.log("For testing mode only, OTP : " + res.otp);
