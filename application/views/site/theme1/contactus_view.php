    ...
    <div class="container main-contact-body">
        ...
        <div class="con-top">
                    ...
                    <form action="<?=base_url('contactus/save')?>" method="post">
                        ...
                        <div class="control-group form-group">
                            <div class="controls">
                                ...
                                <textarea class="form-control" name="message" id="comments" Placeholder="Enter your Comments here" rows="5"></textarea>
                                <?=form_error("message")?>
                            </div>
                        </div>
                        <div id="success"></div>
                        <button class="btn btn-primary add_to_cart" type="submit">Send</button>
                    </form>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
                ...
                <p class="contact-agile1"><strong>Address :</strong> G.S. Road, Bhangagarh, Guwahati, Assam</p>
