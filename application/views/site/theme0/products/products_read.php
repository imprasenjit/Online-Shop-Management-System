			...
			<div class="col-md-9">
				<div class="panel panel-dark">
					<div class="panel-heading panel-primary">
						<i class="fa fa-braille fa-fw"></i> Ms Angle
					</div>
					...
					<div class="row">
						<div class="col-md-5">									
							...
							<div class="col-md-7 "><br />
								...
								<!--<label class="col-md-5 pull-left form-group">Product :</label>
								<div class="col-md-7 form-group">
									<?php echo $byproducts->product_name; ?>
								</div>-->
								<form id="addtocart" method="post" action="<?=base_url();?>shopping/add">	
								
									<!--<label class="col-md-4 pull-left form-group">Length : </label>
									<div class="col-md-8 form-group">
										<select class="form-control" name="p_length<?php echo $byproducts->id ?>" id="p_length<?php echo $byproducts->id ?>">
									...
									<!--<label class="col-md-4 pull-left form-group">Pcs/Ton/Unit: </label>
									<div class="col-md-8 form-group">
										<input class="form-control" type="text" size="10" name="unit<?php echo $byproducts->id ?>" id="unit<?php echo $byproducts->id ?>">
									</div>-->
