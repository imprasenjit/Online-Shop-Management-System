    ...
    <div class="row profile">
		...
		<div class="col-md-8 col-md-offset-2">
			<div class="profile-content" style="margin-top:10px;">
				<h4 align="center">Tell us your Preferences</h4>				
						...
						<div class="panel panel-info">
							...
							<div class="panel-body">
								<form action="<?= base_url(); ?>home/save_quotes_form" method="post"><br />
									...
									<div align="center">
										<button type="submit" class="btn btn-primary btn-lg add_to_cart">Get Quotes</button> 
									</div>
