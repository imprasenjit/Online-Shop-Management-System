...
class Warehouse_model extends CI_Model
{
    ...
    public function add_dispatch_details($purchase_order_to_warehouse_id, $data)
    {
        $this->db->where("purchase_order_to_warehouse_id", $purchase_order_to_warehouse_id);
    ...
    public function get_goods_dispatch_details($po_id)
    {
        $this->db->select("dispatch_doc")
            ->from("purchase_order_to_warehouse")
            ->where(array("purchase_order_to_warehouse_id" => $po_id, "status" => "1"));
