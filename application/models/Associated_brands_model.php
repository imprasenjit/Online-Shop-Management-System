...
class Associated_brands_model extends CI_Model
{

    public $table = 'associated_brands';
    public $id = 'id';
    public $order = 'DESC';
...
/* End of file Associated_brands_model.php */
/* Location: ./application/models/Associated_brands_model.php */
