...
class Home1 extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('site/theme1/newhome');
	...
	public function about() {
		...
		$this->load->view('site/theme1/requires/new_header',$data);
		$this->load->view('site/theme1/new_about');
		$this->load->view('site/theme1/requires/new_footer');
	}
    ...
    function downloads() {
        ...
        $this->load->view('site/theme1/requires/new_header', $data);
        $this->load->view('site/theme1/downloads_view');
        $this->load->view('site/theme1/requires/new_footer');
    }
    function partnerprograms() {
        ...
        $this->load->view('site/theme1/requires/new_header', $data);
        $this->load->view('site/theme1/partnerprograms');
        $this->load->view('site/theme1/requires/new_footer');
    }
